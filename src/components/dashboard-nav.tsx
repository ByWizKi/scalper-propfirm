...
export function DashboardNav() {
  ...
  return (
    <>
      ...
      <div className="hidden lg:flex h-screen w-64 flex-col border-r border-slate-200 bg-white dark:border-[#1e293b] dark:bg-[#151b2e]">
              ...
              <Link
                ...
                href={item.href}
                  className={cn(
                    ...
                    isActive
                      ? "bg-slate-100 text-slate-900 dark:bg-[#1e293b] dark:text-slate-50"
                      : "text-slate-600 hover:bg-slate-50 hover:text-slate-900 dark:text-slate-400 dark:hover:bg-[#1e293b] dark:hover:text-slate-50"
                  )}
              >
        ...
        <div className="border-t border-slate-200 p-4 dark:border-[#1e293b]">
          <div className="flex items-center gap-3 mb-3">
            <div className="flex h-8 w-8 items-center justify-center rounded-full bg-slate-100 dark:bg-[#1e293b]">
            ...
            <div className="flex-1 overflow-hidden">
              ...
              {session?.user?.name && (
                <p className="text-xs text-slate-500 dark:text-slate-400 truncate">{session.user.name}</p>
              )}
            </div>
          </div>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-50 flex items-center justify-between h-16 min-h-[calc(4rem+env(safe-area-inset-top))] px-4 pt-[env(safe-area-inset-top)] border-b border-slate-200 bg-white dark:border-[#1e293b] dark:bg-[#151b2e]">
        ...
        <Sheet open={open} onOpenChange={setOpen}>
          ...
          <SheetContent side="left" className="w-64 p-0">
            <SheetHeader className="border-b border-slate-200 px-6 py-4 dark:border-[#1e293b]">
