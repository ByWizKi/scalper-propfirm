...
interface PnlFilterSectionProps {
  dateFilter: string
  startDate: string
  endDate: string
...
export function PnlFilterSection({
  dateFilter,
  startDate,
  endDate,
  propfirmFilter,
      ...
      <div className="px-4 sm:px-5 lg:px-6 py-3 sm:py-4 border-b border-slate-200/70 dark:border-[#1e293b]/70">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1.5 text-xs sm:text-sm text-slate-600 dark:text-slate-300">
            ...
            <span className="hidden sm:inline">entrée{filteredCount > 1 ? "s" : ""}</span>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4 sm:gap-6">
          ...
          <div className="flex flex-col gap-2 min-w-0">
            ...
            <Select value={amountFilter} onValueChange={onAmountFilterChange}>
              ...
              <SelectContent className="w-[var(--radix-select-trigger-width)]">
                <SelectItem value="all">Tous</SelectItem>
                <SelectItem value="positive">Gains</SelectItem>
                <SelectItem value="negative">Pertes</SelectItem>
              </SelectContent>
            </Select>
          </div>
